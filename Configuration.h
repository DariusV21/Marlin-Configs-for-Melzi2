...
#define STRING_CONFIG_H_AUTHOR "(Darius, Raiscube config)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Dariaus 3D"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 81, 81, 416, 795 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 35, 8, -0.21 }
